# Rose Pine Dark Theme (for zsh-syntax-highlighting)
#
...
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#ebbcba,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#e0def4,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#ebbcba,underline'
